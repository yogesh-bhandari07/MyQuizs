...
<head>
    ...
    <link rel="stylesheet" href="../css/astdresult.css">
        ...
        <div class="row p-0 m-0">
            <div class="col-sm-2 p-1">
                <div class="sidenav">
                    ...
                    <a style="color:yellowgreen;" href="../code/astdresult.php">Result</a>    
            ...
            <div class="col-sm-10 p-0 m-0">
                ...
                <div class="row m-0 p-3">
                    <div class="col-sm-6">
                        ...
                        <input type="text" onkeypress="search_data()" name="enrollment" id="enrollment" placeholder="Enrollment" class="form-control" value="">
                    </div>
                    <div class="col-sm-6">
                        <label for="class">Registration Number</label>
                        <input type="text" name="class" onkeypress="search_data()" id="class" placeholder="Registration Number" class="form-control" value="">
                    </div>
                ...
                <div class="row m-0 p-3" id="rdata">
...
<script src="../js/astdresult.js" async defer></script>
